              ...
              // We later build a deck based on these priorities.
      {
         ...
         for (i = startingCardIndex; < totalCardCount) // Loop through each card.
         {
            ...
            {               
               ...
               case cCivXPAztec:
               {
                  exclude = ((unit == cUnitTypePetJaguar) || (tech == cTechHCNativeTreaties) ||
                     ...
                     (tech == cTechDEHCChichimecaRebellion) || (tech == cTechHCXPShipJaguarKnights1) ||
                     (tech == cTechHCXPTownDance) || (tech == cTechHCXPWaterDance) ||
                     (tech == cTechHCXPShipMacehualtins1) || (tech == cTechmmShipJavelineer3) ||
                     (tech == cTechHCXPShipSkullKnights1) || (tech == cTechmmShipJavelineer2) ||
                     (tech == cTechDEHCShipJaguarKnights6) || (tech == cTechHCXPShipJaguarKnights3) ||
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
               ...
               (tech == cTechDEHCChiribayaDogs) || (tech == cTechHCXPDistributivism) ||          
               ...
               (tech == cTechHCXPShipVillagers3) || (tech == cTechDEHCShipSettlersDutch3) ||
               (tech == cTechHCShipSettlers3) || (tech == cTechDEHCShipSettlersOttoman1) ||                              
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
                ((tech == cTechHCXPAztecMining) || (tech == cTechDEHCChichimecaRebellion) || 
                 ...
                 (tech == cTechYPHCMorutaruRangeJapanese) || (tech == cTechDEHCLandwehr) ||
                  (tech == cTechmmHCRegisterCossackRussian) ||
